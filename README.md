...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf SHARO_TH && rm -rf .telegram-cli && git clone https://github.com/sharoth/SHARO_TH.git && cd superflux-bot && ./launch.sh install && ./launch.sh
~~~~~
